...
(defsystem awdrat 
  ...
  (:serial
   ...
   ("mediator-support" (:module-class joshua:separate-destination-joshua-module))
   ("simulator" (:module-class joshua:separate-destination-joshua-module))
   ("timing" (:module-class joshua:separate-destination-joshua-module))
   ("mediator-coupling" (:module-class joshua:separate-destination-joshua-module))
   ("editor" (:module-class joshua:separate-destination-joshua-module))
   ("node-mapper" (:module-class joshua:separate-destination-joshua-module))
   ("resources" (:module-class joshua:separate-destination-joshua-module))
